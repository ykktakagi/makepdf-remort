// data/dataKey-gsiHazardmapportal.ts
// 国土地理院
import type { LayerInfo } from '@/types/mapTypes';

export const gsiHazardmapportal: Record<string, LayerInfo> = {
  "洪水浸水": {
    url: 'https://disaportaldata.gsi.go.jp/raster/01_flood_l2_shinsuishin_data/{z}/{x}/{y}.png',
    layerType: '色付き画像タイル',
    zoomLevel: { min: 2, max: 17 },
    hanrei: 'https://disaportal.gsi.go.jp/hazardmapportal/hazardmap/copyright/img/shinsui_legend3.png',
  ...
  "浸水継続時間": {
    ...
    layerType: 'ポリゴン描画',
    zoomLevel: { min: 2, max: 17 },
    hanrei: 'https://disaportal.gsi.go.jp/hazardmapportal/hazardmap/copyright/img/shinsui_legend_l2_keizoku.png',
    providedDate: '令和3年5月28日',
    source: '国土交通省各地方整備局等',
    remarks: '本データは、洪水浸水想定区域（浸水継続時間）_国管理河川と洪水浸水想定区域（浸水継続時間）_都道府県管理河川のデータを統合したものです。都道府県管理河川につきましては、都道府県の許諾を得てタイルデータの配信を行っているため、一部の都道府県のデータ配信のみとなっております。',
    colorMap: [
